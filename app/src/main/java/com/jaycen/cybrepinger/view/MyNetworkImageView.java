package com.jaycen.cybrepinger.view;
...
import com.jaycen.cybrepinger.Pref;
	...
	private class MyTarget extends SimpleTarget< Bitmap > {
		...
		@Override public void onLoadFailed( Exception e, Drawable errorDrawable ){
			try{
				...
				// at com.jaycen.subwaytooter.view.MyNetworkImageView$1.onLoadFailed(MyNetworkImageView.java:147)
